				...
				<section id="blogContent">
					...
					<?php foreach($tips as $tip): ?>
						<ul>
							...
							<li style="width:524px;text-align:left"><?php if ($tip['Tip']['thread'] > 1) { ?><img src='/img/i_reply.gif'><?php } ?> <a href="/tip/view/<?=$tip['Tip']['id']?>/page:<?=$paging['page']?>"><?=$tip['Tip']['subject']?></a></li>
