...
xq.Editor = xq.Class(/** @lends xq.Editor.prototype */{
	 ...
	 */
	 initialize: function(contentElement, toolbarContainer) {
		 ...
		 * @type String
		 */
		this.config.imagePathForDefaultToolbar = ''+xq.baseUrl+'images/toolbar/';
		
		/**
		 * Image path for content.
		 * @type String
		 */
		this.config.imagePathForContent = ''+xq.baseUrl+'images/content/';
		
		/**
		 * Image path for dialog.
		 * @type String
		 */
		this.config.imagePathForDialog = ''+xq.baseUrl+'images/dialogs/';
		
		/**
		 * Image path for emoticon.
		 * @type String
		 */
		this.config.imagePathForEmoticon = ''+xq.baseUrl+'images/dialogs/emoticon/';
		 ...
		 * @type Array
		 */
		this.config.contentCssList = [''+xq.baseUrl+'stylesheets/xq_contents.css'];
