...
xq.Editor = xq.Class(/** @lends xq.Editor.prototype */{
	 ...
	 */
	 initialize: function(contentElement, toolbarContainer) {
		 ...
		 * @type String
		 */
		this.config.imagePathForDefaultToolbar = '/js/xquared/images/toolbar/';
		
		/**
		 * Image path for content.
		 * @type String
		 */
		this.config.imagePathForContent = '/js/xquared/images/content/';
		
		/**
		 * Image path for dialog.
		 * @type String
		 */
		this.config.imagePathForDialog = '/js/xquared/images/dialogs/';
		
		/**
		 * Image path for emoticon.
		 * @type String
		 */
		this.config.imagePathForEmoticon = '/js/xquared/images/dialogs/emoticon/';
		 ...
		 * @type Array
		 */
		this.config.contentCssList = ['/js/xquared/stylesheets/xq_contents.css'];
