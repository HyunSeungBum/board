		...
		<!-- aside는 본문내용에 부스러기 들을 넣는다. -->
			...
			<div id="mainContent"> 
				...
				<section id="blogContent">
					<div>
						<form name='frm' id="TipsAddForm" method="post" action="/tip/add" accept-charset="utf-8">
							<input type="hidden" name="_method" value="POST" />
							제목: <input id="title" name="data[Tip][subject]" type="text"  size="80"/> <br><br>
							비밀번호: <input id="password" name="data[Tip][secure]" type="password" size="10" /><br /><br />
							<textarea name="data[Tip][content]" id="xqEditor" rows="10" cols="100"> </textarea><br>
